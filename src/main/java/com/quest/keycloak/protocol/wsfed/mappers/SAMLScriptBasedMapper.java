 ...
 */
public class SAMLScriptBasedMapper extends AbstractWsfedProtocolMapper implements WSFedSAMLAttributeStatementMapper {

    private static final List<ProviderConfigProperty> configProperties = new ArrayList<>();
    public static final String PROVIDER_ID = "wsfed-saml-javascript-mapper";
    private static final Logger LOGGER = Logger.getLogger(SAMLScriptBasedMapper.class);
    private static final String SINGLE_GROUP_ATTRIBUTE = "single";
    ...
    static {
        ...
        property.setHelpText("Name of the SAML attribute you want to put your javascript values into");
    ...
    public String getDisplayCategory() {
        return "SAML " + AttributeStatementHelper.ATTRIBUTE_STATEMENT_CATEGORY;
    }

    @Override
    public String getDisplayType() {
        return "SAML javascript mapper";
    }
